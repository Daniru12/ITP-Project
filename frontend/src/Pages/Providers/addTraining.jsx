...
const AddTraining = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[var(--color-secondary-light)] to-[var(--color-white)]">
      {/* Navigation Bar */}
      <div className="bg-[var(--color-white)] shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <h1 className="text-2xl font-bold text-[var(--text-on-secondary)]">Add Training Service</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[var(--color-white)] rounded-2xl shadow-lg p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-semibold text-[var(--text-on-secondary)]">Service Details</h2>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent transition-all"
                    rows="4"
                    placeholder="Describe your training service, methods used, and experience..."
                  />
                </div>
            ...
            <div className="bg-[var(--color-white)] rounded-2xl shadow-lg p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-semibold text-[var(--text-on-secondary)]">Training Images</h2>
              </div>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-lg p-8 text-center">
                ...
                >
                  ...
                  <span className="text-lg text-gray-500 mb-2">
                    Upload Training Session Images
                  </span>
            ...
            <div className="bg-[var(--color-white)] rounded-2xl shadow-lg overflow-hidden">
              <div className="bg-[var(--color-secondary-light)] p-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-semibold text-[var(--text-on-secondary)]">Basic Training</h3>
                </div>
              </div>
              <div className="p-6 space-y-4">
                ...
                <div>
                  <label className="block text-sm text-[var(--text-on-secondary)] mb-1">Session Duration (min)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm text-[var(--text-on-secondary)] mb-1">Training Topics</label>
            ...
            <div className="bg-[var(--color-white)] rounded-2xl shadow-lg overflow-hidden">
              <div className="bg-[var(--color-accent-light)] p-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-semibold text-[var(--text-on-secondary)]">Premium Training</h3>
                </div>
              </div>
              <div className="p-6 space-y-4">
                <div>
            ...
            <div className="bg-[var(--color-white)] rounded-2xl shadow-lg overflow-hidden">
              <div className="bg-[var(--color-primary-light)] p-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-semibold text-[var(--text-on-secondary)]">Advanced Training</h3>
                </div>
              </div>
              <div className="p-6 space-y-4">
                <div>
                  ...
                  {luxuryPackage.includes.map((service, index) => (
                    <div key={index} className="flex gap-2 mb-2">
                      <input
                        ...
                        className="flex-1 p-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent"
                        placeholder="e.g., Behavior Modification"
                      />
